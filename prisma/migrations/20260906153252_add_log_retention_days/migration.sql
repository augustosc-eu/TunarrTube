...
INSERT INTO "new_AppSettings" ("cacheMaxAgeDays", "cacheMaxMegabytes", "createdAt", "defaultVideoQuality", "id", "jobsPaused", "mediaBaseDirectory", "tunarrUrl", "updatedAt") SELECT "cacheMaxAgeDays", "cacheMaxMegabytes", "createdAt", "defaultVideoQuality", "id", "jobsPaused", "mediaBaseDirectory", "tunarrUrl", "updatedAt" FROM "AppSettings";
