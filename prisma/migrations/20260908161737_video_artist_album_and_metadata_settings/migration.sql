-- AlterTable
ALTER TABLE "Video" ADD COLUMN "album" TEXT;
ALTER TABLE "Video" ADD COLUMN "artist" TEXT;
...
INSERT INTO "new_AppSettings" ("aiProvider", "cacheMaxAgeDays", "cacheMaxMegabytes", "createdAt", "defaultVideoQuality", "id", "jobsPaused", "logRetentionDays", "mediaBaseDirectory", "musicbrainzContactEmail", "tunarrUrl", "updatedAt") SELECT "aiProvider", "cacheMaxAgeDays", "cacheMaxMegabytes", "createdAt", "defaultVideoQuality", "id", "jobsPaused", "logRetentionDays", "mediaBaseDirectory", "musicbrainzContactEmail", "tunarrUrl", "updatedAt" FROM "AppSettings";
