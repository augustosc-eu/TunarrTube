...
export function AiContentSelectForm({ channelId }: { channelId: string }) {
  ...
  return (
    <div className="card" style={{ marginBottom: 24 }}>
      ...
      <p className="muted">Pick one or more Sources; the AI chooses which of their already-downloaded videos fit your brief and adds them here.</p>
      <div className="field">
      ...
      <button className="button secondary" type="button" disabled={busy || !selectedSourceIds.length || !instructions.trim()} onClick={submit}>
