...
export default async function SettingsPage() {
  ...
  return <><PageHeader eyebrow="Local configuration" title="Settings" /><SettingsForm initialDirectory={settings.mediaBaseDirectory} initialTunarrUrl={settings.tunarrUrl} initialCacheMegabytes={settings.cacheMaxMegabytes} initialCacheAgeDays={settings.cacheMaxAgeDays} initialDefaultVideoQuality={settings.defaultVideoQuality} initialMappings={settings.pathMappings} ytDlp={ytDlp} ffmpeg={ffmpeg} /></>;
}
