...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      Settings: { type: "object", required: ["id", "mediaBaseDirectory", "tunarrUrl", "cacheMaxMegabytes", "cacheMaxAgeDays", "logRetentionDays", "defaultVideoQuality", "jobsPaused"], additionalProperties: true, properties: { id: { type: "integer", const: 1 }, mediaBaseDirectory: { type: "string" }, tunarrUrl: { type: "string", format: "uri" }, cacheMaxMegabytes: { type: "integer" }, cacheMaxAgeDays: { type: "integer" }, logRetentionDays: { type: "integer" }, defaultVideoQuality: videoQuality, jobsPaused: { type: "boolean" }, defaultNamingScheme: namingScheme, defaultFilenameTemplate: { type: "string" }, pathMappings: { type: "array", items: pathMapping } } },
      ...
      UpdateSettingsRequest: { type: "object", minProperties: 1, additionalProperties: false, properties: { mediaBaseDirectory: { type: "string", minLength: 1 }, tunarrUrl: { type: "string", format: "uri" }, cacheMaxMegabytes: { type: "integer", minimum: 128, maximum: 10000000 }, cacheMaxAgeDays: { type: "integer", minimum: 1, maximum: 3650 }, logRetentionDays: { type: "integer", minimum: 1, maximum: 3650 }, defaultVideoQuality: videoQuality, defaultNamingScheme: namingScheme, defaultFilenameTemplate: { type: "string", minLength: 1, maxLength: 300 }, pathMappings: { type: "array", maxItems: 50, items: pathMapping } } },
