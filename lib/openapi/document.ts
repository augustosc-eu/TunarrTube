...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      Channel: { type: "object", required: ["id", "name", "channelType", "slug", "templateId", "storageDirectory", "programmingOrder"], additionalProperties: true, properties: { id: { type: "string" }, name: { type: "string" }, channelType: { type: "string" }, slug: { type: "string" }, templateId: { type: "string" }, storageDirectory: { type: "string" }, programmingOrder: { type: "string", enum: ["manual", "oldest", "newest", "random"] }, intakeSourceId: nullableString, tunarrChannelId: nullableString, tunarrChannelNumber: { type: ["integer", "null"] }, createdAt: dateTime, updatedAt: dateTime } },
      ...
      UpdateChannelRequest: { type: "object", minProperties: 1, additionalProperties: false, properties: { name: { type: "string", minLength: 1, maxLength: 160 }, templateId: { type: "string", minLength: 1 }, programmingOrder: { type: "string", enum: ["manual", "oldest", "newest", "random"] }, logoAssetPath: nullableString, tunarrRequestedChannelNumber: { type: ["integer", "null"], minimum: 1 } } },
